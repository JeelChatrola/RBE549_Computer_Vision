...
def run_experiments():
    res_sift_bf, time_sift_bf = sift_bf_match(img1, img2)
    res_sift_flann, time_sift_flann = sift_flann_match(img1, img2)
    res_surf_bf, time_surf_bf = surf_bf_match(img1, img2)
    res_surf_flann, time_surf_flann = surf_flann_match(img1, img2)

    print('SIFT - BF Matcher Time: ', time_sift_bf)
    print('SURF - BF Matcher Time: ', time_surf_bf)
    print('SIFT - FLANN Matcher Time: ', time_sift_flann)
    print('SURF - FLANN Matcher Time: ', time_surf_flann)
